...
Buka terminal pada folder project, kemudian jalankan program menggunakan perintah:
...
|---|---|---|---|---|---|
| 1 | (0, 0) | (3, 4) | 5.00 | (1.50, 2.00) | Berhasil |
| 2 | (-2, 1) | (4, 1) | 6.00 | (1.00, 1.00) | Berhasil |
| 3 | (2.5, -1) | (2.5, 3) | 4.00 | (2.50, 1.00) | Berhasil |

## Refleksi

Konsep yang paling saya pahami adalah penggunaan variabel, input-output, dan operator dalam Python karena dapat langsung diterapkan dalam program sederhana.

Kesalahan yang saya temukan adalah memahami bahwa input dari pengguna perlu dikonversi ke tipe data yang sesuai sebelum digunakan dalam perhitungan. Saya memperbaikinya dengan menggunakan fungsi `int()` atau `float()` sesuai kebutuhan.

Pada pertemuan berikutnya saya ingin lebih memahami materi pemrograman Python yang lebih kompleks.
